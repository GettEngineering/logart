...
// Source: ./log-art/interface.go

// Package mock_logart is a generated GoMock package.
package mock_logart

import (
	gomock "github.com/golang/mock/gomock"
	log_art "github.com/gtforge/logart/log-art"
	reflect "reflect"
)
...
func (m *MockLogger) WithField(key string, value interface{}) log_art.Logger {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithField", key, value)
	ret0, _ := ret[0].(log_art.Logger)
	return ret0
}
...
func (m *MockLogger) WithFields(fields log_art.Fields) log_art.Logger {
	m.ctrl.T.Helper()
...
func (m *MockLogger) WithError(err error) log_art.Logger {
	m.ctrl.T.Helper()
